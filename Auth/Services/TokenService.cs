...
namespace Lensisku.Auth.Services
{
    ...
    public class TokenService : ITokenService
    {
        ...
        public TokenService(JwtSettings jwtSettings)
        {
            ...
            // Retrieves secrets from environment variables or configuration.
        ...
        public string GenerateAccessToken(User user, IEnumerable<string> permissions, Guid? sessionId)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                // 'user.Role.Name' assumes that the User object has its Role navigation property loaded.
                new Claim("role", user.Role.Name), // Assuming User.Role is a navigation property to Role entity with Name
        ...
        public string GenerateRefreshToken(User user, Guid? sessionId)
        {
            ...
            var claims = new List<Claim>
            {
                ...
                new Claim("username", user.Username), // For identification if needed from refresh token
                 new Claim("role", user.Role.Name), // For identification if needed from refresh token
            };
